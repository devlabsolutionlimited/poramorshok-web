        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            <div className="inline-flex items-center gap-2 bg-[#0EBE7F]/10 px-4 py-2 rounded-full mb-8 backdrop-blur-sm border border-[#0EBE7F]/20">
              ...
              <span className="text-sm font-medium text-[#0EBE7F]">Transform Your Career</span>
            </div>
            ...
            <p className="text-xl text-[#0EBE7F]/90 mb-8">
              Join thousands of students who are accelerating their careers with personalized mentorship
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/mentors">
                ...
                >
                  ...
                  <span className="relative">Browse Mentors</span>
                </Button>
              </Link>
            </div>
          </div>
